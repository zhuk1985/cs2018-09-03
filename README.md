...
2. Выберите upstream https://github.com/itacad/cs2018-09-03/ как источник и выберите ветку master)
3. Скопируйте из \_tasks_ папку с заданиями (lessonXX) в свою папку.
